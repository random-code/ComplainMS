...
insert into tblcomplain
	( dte, acc, phn, name, compnature, text, status,compid,agent,street,employee1,employee2,division)
	values
	( \"$dte\", \"$acc\", \"$phn\", \"$name\", \"$compnature\", \"$text\", \"$status\", \"$compid\", \"".GetAdminID("$UID")."\",\"$st\",\"$emp1\",\"$emp2\",\"$div\")
";
