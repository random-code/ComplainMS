...
$lay = new IS_Layout("{$constant['temple_path']}/EdEM.htm");
...
$strSQL = "select * from tblemployees where id='$id'";
...
$lay->replace('TF_Des',$designation);
$lay->replace('TF_Rem',$remarks);
$lay->replace('TF_Anum',$anumber);
