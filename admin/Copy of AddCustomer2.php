...
#print "\$ffnStreet1	      : $ffnStreet1	    <br>";
#print "\$ffncontact1      : $ffncontact1    <br>";
#print "\$ffnStreet2	      : $ffnStreet2	    <br>";
#print "\$ffncontact2      : $ffncontact2    <br>";
#exit;
$err="";
...
insert into tblcustomer 
	( name,mname,lname, company, street1, street2, city, state, country, zip, phone, cell, fax, pwd, 
	 identification, email, accno, dealerid, createdate,title,nstreet1,nstreet2,ncontact1,ncontact2,sector,vanid
	)
	values
	('$ffname','$ffmname','$fflname', '$ffcompany', '$ffstreet1', '$ffstreet2', '$ffcity', '$ffstate', '$ffcountry', '$ffzip', '$ffphone', '$ffcell', '$fffax',  '$ffpwd',
	'$ffID','$ffemail',$accno,'1',sysdate(),'$fftitle','$ffnStreet1','$ffnStreet2','$ffncontact1','$ffncontact2',$ffsector,'$ffvan') 
