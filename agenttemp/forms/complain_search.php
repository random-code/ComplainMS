									...
									<div class="span10">
															<div class="row-fluid">
																...
																<ul class="unstyled spaced">
                                                                 ...
                                                                 <input id="id-date-range-picker-1" style ='width:212px;margin-left:66px'class="span10" type="text" name="date-range-picker">
                                               <!-- </div> -->
																	...
																	<li style='line-height:33px;'>
																		<i class="icon-caret-right blue"></i>
																		Search Key
																		<input style='margin-left:107px;width:200px;' id="rank" type="text" name="Flat">
																	</li>
																	...
																	<li style='line-height:33px;'>
																		...
																		<td class="hidden-480">
													                    <select name="sample-table-2_length" style='margin-left:135px;width:216px;'size="1" aria-controls="sample-table-2">
                                                                     ...
                                                                     <li style='line-height:33px;'>
																		...
																		<td class="hidden-480">
													                    <select name="sample-table-2_length" style='margin-left:128px;width:216px;'size="1" aria-controls="sample-table-2">
